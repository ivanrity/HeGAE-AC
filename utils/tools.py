...
def evaluate_results_nc(embeddings, labels, num_classes):
    ...
    # return svm_macro_f1_list, svm_micro_f1_list, nmi_mean, nmi_std, ari_mean, ari_std,purity_mean,purity_std,ri_mean,ri_std,f_measure_mean,f_measure_std
    return svm_macro_f1_list, svm_micro_f1_list,

def evaluate_results_nc2(embeddings, labels, num_classes):
    # print('SVM test')
