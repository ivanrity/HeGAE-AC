...
class MAGNN_nc_ac(nn.Module):
    def __init__(self,
        ...
        self.GCN = GCN(hidden4RGCN,drop4Rgcn,adj_full,feats_dim_list,gamma=3.0,num_layers=3)
    ...
    def forward(self, inputs, target_node_indices):
        ...
        recon_feat_list, emb_loss, recon_loss = self.GCN(A=self.adjM, X=self.X,dataset=self.dataset)
